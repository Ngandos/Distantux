<?php
    ...
    if(empty($_SESSION['pseudo'])) {
        header('location: ./devweblogin.php');
    }
...
<head>
    ...
    <link rel="stylesheet" href="./devwebstudyers.css">
    <style type="text/css">
        h2 {
            margin-right: 6%;
        }
    ...
    <title>Tableau de bord Web Dev</title>
</head>
<body>
    <header>
        <div class="ID">
    ...
    <section class="Middle">
        <article class="menu">
            <div class="nav">
                ...
                <button class="navbut"><a class="navlinks" href="#">Gestion de mes documents</a></button>
                <button class="navbut"><a class="navlinks" href="./devwebmessagerie.php">Espace messagerie</a></button>
            </div>
        </article>
            ...
            <div class="invoices">
                <form id="grpmess" action="" method="POST">
                    ...
                    <select required name="formation" id="mess">
                        ...
                        <option value="Fromateur">Disussion formateur</option>
                    </select>
