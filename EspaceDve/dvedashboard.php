...
<head>
    ...
    <title>Tableau de bord DVE</title>
</head>
<body>
    <header>
        <div class="ID">
    ...
    <section class="Middle">
        <article class="menu">
            <div class="nav">
                ...
                <button class="navbut"><a class="navlinks" href="#">Gestion de mes douments</a></button>
                <button class="navbut"><a class="navlinks" href="../messagerie/messagerie.php">Espace messagerie</a></button>
            </div>
        </article>
